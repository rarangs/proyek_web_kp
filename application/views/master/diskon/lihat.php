...
<html lang="en">
  <head>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                          <?php foreach ($all_diskon as $diskon): ?>
                          <tr>
                              <?php if ($this->session->login['role'] == 'admin') : ?>
                                <td>
                                     <a
                                      href="<?= ('diskon/ubah/'. $diskon->id_diskon) ?>"
                                      class="btn btn-success btn-sm">
                                      Edit
                                     </a>
                                     <a
                                       onclick="return confirm('apakah anda yakin?')"
                                       href="<?=base_url('diskon/hapus/' .$diskon->id_diskon) ?>"
    ...
    <div class="modal-dialog" role="document">
       ...
       <form
    action="<?= base_url('diskon/proses_tambah') ?>"
    id="form-tambah"
    method="POST">
    <div class="form-row">
    <div class="form-group col-md-6">
            ...
            <input
                type="number"
                name="id_diskon"
                placeholder="Masukkan Id Diskon"
                autocomplete="off"
                class="form-control"
                required="required"
                value="KD<?= mt_rand(100000, 999999) ?>"
                maxlength="8"
                readonly="readonly">
        </div>
        <div class="form-group col-md-10">
            <label for="nama_diskon">
                <strong>Nama Diskon</strong>
            </label>
            <input
                type="text"
                name="nama_diskon"
        ...
        <div class="form-group col-md-10">
            <label for="jenis_diskon">
                <strong>Jenis Disc</strong>
            </label>
                <select name="jenis_diskon" id="jenis_diskon" class="form-control" required="required">
